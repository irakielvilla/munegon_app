...
file_path = r"c:\Users\iraki\Desktop\Muñegon app carpeta\Muñegon App\src-tauri\src\commands\ventas.rs"
with open(file_path, "r", encoding="utf-8") as f:
    content = f.read()

# 1. Update marcar_sincronizados
old_marcar_sig = """pub fn marcar_sincronizados(
...
new_marcar_sig = """pub fn marcar_sincronizados(
    venta_ids: Vec<String>,
    producto_ids: Vec<String>,
    log_ids: Vec<String>,
    corte_ids: Vec<String>,
...
content = content.replace(old_marcar_sig, new_marcar_sig)
content = content.replace(old_marcar_body, new_marcar_body)

# 2. Add obtener_clientes_pendientes and obtener_deudas_pendientes at the end of the file
new_functions = """
...
with open(file_path, "w", encoding="utf-8") as f:
    f.write(content)
print("Updated ventas.rs successfully.")
